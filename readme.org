...
| Bottom | toggle floating | shrink     | grow       | toggle orientation | toggle stack    |
...
| toggle stack    | unjoin stacked windows    |
...
|      | AltGr  | to Sym   | to Window |     | float      | shrink  | grow    | orient  | stack     |
|------+--------+----------+-----------+-----+------------+---------+---------+---------+-----------|
|      |        |          |           |     |            | last ws |         |         |           |
